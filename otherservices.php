...
<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">
  ...
  <p class="text-gray-700 mt-2">सारे डेटा रिजेक्ट हो रहे हैं! मैंने आपको स्क्रीनशॉट भेजा है, देखिए और समझिए।</p>
...
<div class="bg-blue-100 border border-blue-400 text-blue-800 px-6 py-4 rounded-lg shadow-md">
  <p class="text-xl font-bold mb-2">यदि आपको नया पैन कार्ड बनवाना है, पुराने पैन कार्ड में कोई अपडेट या सुधार कराना है, तो हम आपकी सहायता के लिए यहाँ हैं। 📝</p>
  <p class="text-gray-700">हम नए पैन कार्ड के आवेदन, पैन कार्ड अपडेट, और पैन कार्ड करेक्शन (जैसे नाम, जन्म तिथि, पता आदि) से जुड़े सभी कार्यों में आपकी मदद करते हैं। ✅</p>
  <p class="text-gray-700 mt-2">हमारी सेवाओं का लाभ उठाकर आप आसानी से और बिना किसी परेशानी के अपना पैन कार्ड सही करा सकते हैं।</p>
</div>


<div class="bg-orange-100 border border-orange-400 text-orange-800 px-6 py-4 rounded-lg shadow-md">
  <p class="text-xl font-bold mb-2">सिर्फ 2 घंटे में पैन कार्ड बनवाएं! ⏳</p>
  <p class="text-gray-700">अगर आपको तुरंत पैन कार्ड की आवश्यकता है, तो हमारी तेज़ और विश्वसनीय सेवा का लाभ उठाएं। 📝</p>
  <p class="text-gray-700 mt-2">हम नए पैन कार्ड बनवाने, पैन कार्ड अपडेट और करेक्शन (नाम, जन्म तिथि, पता आदि) को बेहद तेज़ी से पूरा करते हैं। ✅</p>
  <p class="text-gray-700 mt-2">बिना किसी झंझट के, अब सिर्फ 2 घंटे में पैन कार्ड प्राप्त करें!</p>
</div>
