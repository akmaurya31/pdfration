...
// Fetch all records without limiting the query as pagination will now be handled on the client side
if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
...
<script>
    $(document).ready(function() {
        // Initialize DataTables on the #requestTable
        $('#requestTable').DataTable({
            "paging": true,       // Enable pagination
            "searching": true,    // Enable search functionality
            "ordering": true,     // Enable column ordering
            "pageLength": 10,     // Set initial page length
            "lengthMenu": [5, 10, 25, 50]  // Define the page length options
        });
    });
</script>
