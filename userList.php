    ...
    <div class="overflow-x-auto">
        <table id="" class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                $sql = "SELECT * FROM users WHERE istatus=0 and (name LIKE '%$search%' OR email LIKE '%$search%'  OR contact_number LIKE '%$search%')  ORDER BY id DESC LIMIT $users_per_page OFFSET $offset";
